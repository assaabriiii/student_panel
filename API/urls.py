...
from .views import UniversityNumberLoginAPIView, DashboardAPIView, TADashboardAPIView, MarkAttendanceAPIView
...
urlpatterns = [
    ...
    path('mark_attendance/', MarkAttendanceAPIView.as_view(), name='mark_attendance_api'),
]